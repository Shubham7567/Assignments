public class Programm15 //to calculate the radius of pond
{
    public static void main(String[] args)
    {
        int fishCount = 20;     //Number of fishes in pond
        ...
        System.out.println("To hold " + fishCount + " fishes averaging " + fishLength 
        + " inches long, you need a pond with an area of \n"+
        pondArea + " squarefeet.");

        System.out.println(
            "The radius of pond with area " + pondArea + " squarefeet is \n" + feet + " feet and " + inches + " inches."
        );
    }
}